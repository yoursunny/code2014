...
switch ($_GET['n']) {
	case 1:
		$text='yoursunny.com+'.substr(date('Ymd'),3).'@Gmail.com';
		break;
	case 2:
		$text='sunny@yoursunny.com';
		break;
	case 3:
		$text='shijunxiao@email.arizona.edu';
		break;
	case 4:
		$text='sip:phone@yoursunny.com';
		break;
}
$l=$_GET['l'];
