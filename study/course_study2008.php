...
function go_download(resp) {
	...
	$('download_link').update('<a href="'+o.url+'" style="font-size:150%;">'+o.url+'</a><br/>感谢你输入reCAPTCHA验证码，为图书数字化作出一份贡献');
...
//]]></script>
<?php
	course_downafter($title,$desc,$file,1);
}
?>