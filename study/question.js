...
*/
document.write('<link rel="stylesheet" type="text/css" href="'+WebSite.domain+'/study/images/question'+(WebSite.goodUA?'':'_ie')+'.css"/>');
function q_init() {
	...
	$$('.footer .links').invoke('insert','<li><a href="http://www.famfamfam.com/lab/icons/silk/" rel="external">Silk Icons</a></li>');
	WebSite.NewWinLink();
}
function q_reset() {
	$$('.q').each(function(q){
