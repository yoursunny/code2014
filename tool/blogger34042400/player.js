...
Delicious.Mp3 = {
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.mp3$/i)) {
				...
				img.src = 'http://yoursunny.com/tool/blogger34042400/play.gif'; img.title = 'Play'
	...
	toggle: function(img, url) {
		if (Delicious.Mp3.playimg == img) Delicious.Mp3.destroy()
			...
			img.src = 'http://yoursunny.com/tool/blogger34042400/stop.gif'; img.title = 'Stop'; Delicious.Mp3.playimg = img;
			...
			'<param name="movie" value="http://yoursunny.com/tool/blogger34042400/mp3.swf" /><param name="quality" value="high" />' +
			'<embed style="vertical-align:bottom;margin-right:0.2em" src="http://yoursunny.com/tool/blogger34042400/mp3.swf" flashVars="theLink='+url+'&amp;fontColor='+c+'"'+
	...
	destroy: function() {
		Delicious.Mp3.playimg.src = 'http://yoursunny.com/tool/blogger34042400/play.gif'; Delicious.Mp3.playimg = null
