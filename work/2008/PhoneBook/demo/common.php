<?php
//程序URL
define('APP_ROOT','http://www.65536.cn/work/2008/PhoneBook/demo');
//define('APP_ROOT','http://pb.sunny');

# --------------------登录认证--------------------
//保存认证信息的cookie名称
define('COOKIE_AUTH','PhoneBook_auth');
//认证信息加密参数
define('AUTH_KEY','3e921bfb52328abd3dd6ffc71ede3118bdf0b577bc96eea2c0557d0');
//检查登录，返回用户id或NULL
function CheckLogin() {
