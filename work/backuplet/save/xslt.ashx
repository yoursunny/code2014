...
namespace yoursunny.P2010.GoDaddyWeb
{
    public class backupletXSLTHandler : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            bool is2010 = context.Request.QueryString["v"] == "2010";
            ...
            xsl.Transform("http://yoursunny.com/work/backuplet/save" + (is2010 ? "2010" : string.Empty) + "/atom.php?sid=" + sid + "&ip=" + context.Request.UserHostAddress, new XmlTextWriter(context.Response.Output));
        }
